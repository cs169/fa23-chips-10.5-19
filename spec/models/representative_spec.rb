...
#       expect(described_class).to receive(:create!).with({ name: 'Oski Bear', ocdid: 'ocdid1', title: 'Office 1' })
#       expect(described_class).to receive(:create!).with({ name: 'Michael Ball', ocdid: 'ocdid2',
# title: 'Office 2' })
