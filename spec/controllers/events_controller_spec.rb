...
RSpec.describe EventsController, type: :controller do
  ...
  #         @state = State.create(symbol: 'test_state', symbol: 'test_state',
  #   fips_code: 'test_state', is_territory: 'test_state', lat_min: 'test_state',
  #   lat_max: 'test_state', long_min: 'test_state', long_max: 'test_state' )
  #   #         @county = County.create(state_id: @state.id, name: 'test_county',
  #   fips_code: 'test_county', fips_class: 'test_county', created_at: dummyDate, updated_at: dummyDate)
  #   #     end
